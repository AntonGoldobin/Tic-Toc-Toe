...
cp src/images/logo.svg  _assets/website/images/logo.svg
cp src/images/bg.png  _assets/website/images/bg.png
cp src/images/bg-mobile.png  _assets/website/images/bg-mobile.png